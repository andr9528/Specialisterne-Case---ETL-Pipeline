    ...
    public class BmeConfiguration : EntityConfiguration<Bme>
    {
        ...
        public override void Configure(EntityTypeBuilder<Bme> builder)
        {
            ...
            builder.Property(x => x.ReaderId)
                .HasColumnName(StringExtensions.ToSnakeCase(nameof(Bme.ReaderId)));

            builder.Property(x => x.Location)
                .HasColumnName(StringExtensions.ToSnakeCase(nameof(Bme.Location)))
                .HasMaxLength(7)
                .HasConversion(
                    x => StringExtensions.ToSnakeCase(x.ToString()),
                    x => Enum.Parse<Location>(x, ignoreCase: true));

            builder.Property(x => x.Humidity)
                .HasColumnName(StringExtensions.ToSnakeCase(nameof(Bme.Humidity)))
                .HasColumnType("numeric(20,13)");

            builder.Property(x => x.Pressure)
                .HasColumnName(StringExtensions.ToSnakeCase(nameof(Bme.Pressure)))
                .HasColumnType("numeric(20,13)");

            builder.Property(x => x.Temperature)
                .HasColumnName(StringExtensions.ToSnakeCase(nameof(Bme.Temperature)))
                .HasColumnType("numeric(20,13)");

            builder.Property(x => x.ObservedAt)
                .HasColumnName(StringExtensions.ToSnakeCase(nameof(Bme.ObservedAt)));

            builder.Property(x => x.PulledAt)
                .HasColumnName(StringExtensions.ToSnakeCase(nameof(Bme.PulledAt)));
