...
{
    public class ScdReadDtoFactory : ReadDtoFactoryBase<Scd, ReadDtoScd, ScdReadDtoFactory>
    {
        /// <inheritdoc />
        public ScdReadDtoFactory(ILogger<ScdReadDtoFactory> logger) : base(logger)
        {
        }
    }
}